...
sgMail.setApiKey(
  "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"
);
...
app.post("/register", async (req, res) => {
  try {
    ...
    const emailData = {
      from: "clubme.tr@gmail.com",
      to: email,
      subject: `Account activation link`,
      html: `
          <h1>Please use the following link to activate your account</h1>
          <p><a href="localhost:3001/activation/${token}">Activation link</p>
          <hr />
